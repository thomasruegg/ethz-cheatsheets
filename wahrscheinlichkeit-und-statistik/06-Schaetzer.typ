...
$
  EE_vartheta [(overline(X)_n)^2] &= Var_vartheta [overline(X)_n] + EE_vartheta [overline(X)_n]^2 \
  &= 1/n Var_vartheta [X] + EE_vartheta [X]^2 quad quad quad #text(fill: luma(50%), size: 8pt)[$(Var[overline(X)_n] = 1/n Var[X])$] \
