...
#align(center)[
  #table(
    columns: (1fr, 0.8fr, 1.1fr, 0.7fr, 1fr, 1.6fr, 1.6fr),
    align: horizon + center,
    stroke: 0.5pt + luma(150),
    inset: 0.8em,
    [*Verteilung*], [*Notation*], [*Parameter*], [*$E[X]$*], [*$Var(X)$*], [*$p_X (t)$ bzw. $f_X (t)$*], [*$F_X (t)$*],
    [Gleichverteilung \ (diskret)],
    [unbekannt],
    ...
    [Bernoulli], [$Ber(p)$], [$p$: ErfolgsW'keit], [$p$], [$p(1-p)$], [$p^t(1-p)^(1-t)$], [$1-p$ für $0 <= t < 1$],
    [Binomial],
    [$Bin(n, p)$],
    ...
    [Geometrisch], [$Geo(p)$], [$p$: ErfolgsW'keit], [$1/p$], [$(1-p)/p^2$], [$p(1-p)^(t-1)$], [$1 - (1-p)^t$],
    [Poisson],
    [$Poisson(lambda)$],
